/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 11bb94f077df7eacced49a57aee43b26)
...
interface __BaseEnv_Env {
	...
	TENANT_DB: DurableObjectNamespace<import("./src/index").TenantDB>;
	TENANT_FEATURE_DB: DurableObjectNamespace<import("./src/index").TenantFeatureDB>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChannelDO" | "TenantDB" | "TenantFeatureDB";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WRITE_KEY">> {}
}
